...
description: Translate English academic papers in markdown format to Korean. Use when user requests translation of research papers, academic documents, or scientific articles from English to Korean.
---

# Paper Translator (English to Korean)

## When to Use
Use this skill when:
- User requests translation of English academic papers to Korean
- Input is markdown-formatted academic content
- User asks to translate research papers, journal articles, or scientific documents
...
- Identify sections (Abstract, Introduction, Methods, Results, Discussion, Conclusion)
- **IMPORTANT**: Identify sections that should NOT be translated:
  - **References/Bibliography** (REFERENCES, 참고문헌, Bibliography, Works Cited, etc.)
  - **Appendix/Appendices** (APPENDIX, 부록, Supplementary Material, etc.)
  - **Acknowledgements/Acknowledgments** (ACKNOWLEDGEMENTS, 감사의 글, Acknowledgment, etc.)
  - These sections should be copied as-is without translation
- Note technical terms, equations, citations, and figures
...
- **Academic Terms**: Maintain English terms in parentheses for key technical vocabulary
  - Example: "machine learning (머신러닝)" on first occurrence
- **Maintain Formality**: Use formal Korean academic writing style (합니다체)
- **Preserve Citations**: Keep citation formats unchanged [1], (Smith et al., 2023)
- **Equations**: Keep mathematical notation as-is
- **Figures/Tables**: Translate captions and descriptions
...
3. **Translate ALL sections automatically**:
   ...
   - **SKIP sections that should NOT be translated**:
     - References/Bibliography: Copy section header as "## 참고문헌 (REFERENCES)" but keep all reference entries in original English
     - Appendix: Copy section header as "## 부록 (APPENDIX)" but keep content in original English
     - Acknowledgements: Copy section header as "## 감사의 글 (ACKNOWLEDGEMENTS)" but keep content in original English
...
- For CS papers: Programming terms often stay in English
- For medical papers: Use established Korean medical terminology
- Maintain all reference numbers and bibliography format
